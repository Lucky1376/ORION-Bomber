...
###### [![geonodee](https://img.shields.io/badge/Telegram-blue?style=for-the-badge&logo=Telegram)](http://tx.me/orion_bomber)
#
# 💻Меню
...
## [**`Телеграм канал`**](http://tx.me/orion_bomber) `или` [**`FeedBack BOT`**](http://tx.me/orion_feedback_bot)
#
___
# 🌐Установка
+ #### **Termux (Android):**
  + `Установить` [**`Termux`**](https://tx.me/orion_bomber/5)
  + `pkg upgrade -y`
  + `pkg update -y`
  + `pkg install git`
